...
public class FurnitureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Models models[] = {new Models(R.drawable.furniture_one, "Model 1"),
                new Models(R.drawable.furniture_two, "Model 2"),
                new Models(R.drawable.furniture_three, "Model 3"),
                new Models(R.drawable.furniture_four, "Model 4"),
                new Models(R.drawable.furniture_five, "Model 5"),
                new Models(R.drawable.furniture_six, "Model 6"),
                new Models(R.drawable.furniture_seven,"Model 7"),
                new Models(R.drawable.furniture_eight, "Model 8")};
