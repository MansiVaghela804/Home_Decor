...
public class MyAccountActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    EditText firstname, lastname, email, contactno,password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactno = (EditText) findViewById(R.id.text_contactno);
        password = (EditText) findViewById(R.id.text_password);


        firstname.setText(preferenceManager.getKeyValueString(VariableBag.FIRSTNAME));
        lastname.setText(preferenceManager.getKeyValueString(VariableBag.LASTNAME));
                ...
                if (resultCode == RESULT_OK) {
                    if (requestCode == SELECT_PICTURE) {
                        ...
                        if (null != selectedImageUri) {
                            ...
                            findViewById(R.id.setimage).post(new Runnable() {
                                @Override
                                public void run() {
                                    ((ImageView) findViewById(R.id.setimage)).setImageURI(selectedImageUri);
                                }
                            });
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SETTINGS",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        openAppSettings(MyAccountActivity.this);
                    }
                });
        alertDialog.show();
    }
